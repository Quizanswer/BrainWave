  ...
  const sliderData = [
    {
      ...
      description:
        " Lorem ipsum dolor sit, amet consectetur adipisicing elit. Numquam aliquam suscipit eligendi voluptatem, cum sed.",
      ...
      {sliderData?.map((slider) => {
        return (
          <div className="relative h-full">
            <img
              className="sm:min-h-[320px] max-h-[800px] min-h-96 w-full sm:object-cover"
              src={slider.img}
              alt={slider.title}
            />
            {/** BANNER TEXT SECTION **/}
            <div className="absolute xl:ml-[150px] top-[6%] sm:top-[8%] md:top-[18%] lg:top-[25%] left-[4%] lg:left-[7%] sm:w-[40%] sm:mx-0 mx-auto w-[80%]">
              ...
              <div className="space-y-2 sm:space-y-4 lg:space-y-7">
                <h1 className="text-xl font-semibold text-center sm:text-3xl lg:text-5xl sm:text-start">
                  {slider.title}
                </h1>
                <p className="text-gray-800  text-sm sMtext-xs lg:text-[17px] text-center sm:text-start">
                  {slider.description}
                </p>
                {/** ICON SECTION **/}
                <section className="flex flex-col items-center sm:flex-row gap-x-3 gap-y-2 sm:gap-y-0">
                  <div className="flex items-center space-x-2">
                    <p className="text-red-600 text-sm sm:text-xs md:text-xl lg:text-[17px]">
                      {slider.iconsOne}
                    </p>
                    <p className="text-sm sm:text-xs">{slider.iconTitleOne}</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    <p className="text-sm text-red-600 sm:text-xs">
                      {slider.iconTwo}
                    </p>
                ...
                {/** BUTTON SECTION **/}
                <section className="flex flex-col items-center sm:flex-row gap-x-3 gap-y-3 sm:gap-y-0">
                  <Button
                    variant="destructive"
                    className="text-sm sm:text-xs lg:text-[17px]"
                  >
                    {slider.btnOne}
                  </Button>
                  <Button
